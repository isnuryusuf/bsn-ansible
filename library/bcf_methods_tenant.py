...
class BigCloudFabric(object):
    ...
    def __init__(self, username='admin', password='bsn123',
                 controller_ip='54.255.245.195'):
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            segment_name=dict(required=False),
            vlan_id=dict(required=False),
            interfaces=dict(required=False),
            port_group=dict(required=False),
    ...
    segment_name = module.params['segment_name']
    vlan_id = module.params['vlan_id']
    interfaces = module.params['interfaces']
    port_group = module.params['port_group']
    switch = module.params['switch']

    fab = BigCloudFabric(controller_ip=controller, username=username, password=password)
    #fab = BigCloudFabric(controller_ip=controller, username=username, password=password, tenant_name=tenant_name, segment_name=segment_name, vlan_id=vlan_id, interface=interfaces, port_group=port_group, switch=switch)
    ...
    #fab = BigCloudFabric(controller_ip='3.0.91.58', username='admin', password='bsn123')
    ...
    create=fab.create_tenant(tenant_name)
    module.exit_json(ansible_facts=dict(bsnbcf=create))
    ...
    #interfaces = 'any'
    #switch = 'any'
    #fab.create_segment(tenant_name, segment_name, vlan_id, port_group, interfaces, switch)
    #create=fab.create_segment(tenant_name, segment_name, vlan_id, port_group, interfaces, switch)
    #module.exit_json(ansible_facts=dict(bsnbcf=create))
